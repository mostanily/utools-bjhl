        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("500"),
                    "内的敌人造成",
                    speSkillCon("1350%最终攻击的雷元素伤害"),
                    "+",
                    speSkillCon("1350%体质的雷元素伤害"),
                    "，同时自身进入「引雷·铸劫」状态：攻击提升",
                    speSkillCon("30%"),
                    speSkillCon("（属性乘区·攻击力加成）", SkillColorEnum.injuries),
                    "，基础减伤增加",
                    speSkillCon("15%~25%（[防御依赖]）", SkillColorEnum.normal, ToastSkillEnum.防御依赖),
                    speSkillCon("（属性乘区·基础减伤）", SkillColorEnum.injuries),
                    "持续",
                    speSkillCon("30"),
                    "秒。",
                    ...
                    speSkillCon("300"),
                    "范围内的所有敌人造成",
                    speSkillCon("56%最终攻击的雷元素伤害"),
                    "+",
                    speSkillCon("56%的体质的雷元素伤害"),
                    "（每秒最多触发一次）。",
                    "",
        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("3"),
                    "个主要目标造成",
                    speSkillCon("3500％最终攻击的炎元素伤害"),
                    "，随后对",
                    speSkillCon("450"),
                    "半径范围造成",
                    speSkillCon("1000％最终攻击的炎元素伤害"),
                    "，并留下半径",
                    speSkillCon("250"),
    ...
    "温留": [
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("300"),
                    "范围造成",
                    speSkillCon("1400％最终攻击的物理伤害"),
                    "，每点",
                    speSkillCon("[天相]", SkillColorEnum.normal, ToastSkillEnum.天相),
                    "额外造成",
                    speSkillCon("14％最终攻击的物理伤害"),
                    "，每点",
                    speSkillCon("[天相]", SkillColorEnum.normal, ToastSkillEnum.天相),
                    "使自身【沧海尽扫】的自动技能伤害提高",
                    speSkillCon("1%"),
        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("12"),
                    "秒，对自身前方单体目标造成",
                    speSkillCon("2240％最终攻击的物理伤害"),
                    "，随后对半径",
                    speSkillCon("300"),
                    "扇形造成",
                    speSkillCon("1344％最终攻击的物理伤害"),
                    "，并附带破坏",
                    speSkillCon("2段格挡条"),
                    "效果，根据当前姿态触发的额外效果：",
                    "",
    ...
    "云无月": [
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    "对敌方单位造成",
                    speSkillCon("400%体质的蚀元素伤害"),
                    "+",
                    speSkillCon("250%专精的蚀元素伤害"),
                    ...
                    speSkillCon("[复调]", SkillColorEnum.normal, ToastSkillEnum.复调),
                    "对敌方单位造成",
                    speSkillCon("600%最终攻击的蚀元素伤害"),
                    "+",
                    speSkillCon("350%专精的蚀元素伤害"),
                    "，敌方单位为精英目标时该伤害额外提高",
                    speSkillCon("30%"),
        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("1500"),
                    "范围内的随机目标放射电流，共造成",
                    speSkillCon("150%最终攻击的雷元素伤害"),
                    ";蓄力后，对正前方宽度",
                    speSkillCon("450"),
                    "范围发射超远电磁炮，对路径上敌人造成",
                    speSkillCon("1200%最终攻击的雷元素伤害"),
                    "，并摧毁敌方投射物",
                    "",
        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    "",
                    "回复",
                    speSkillCon("45%最大生命值"),
                    "",
                    "提升",
                    speSkillCon("30%[同调者攻击]", SkillColorEnum.normal, ToastSkillEnum.同调者攻击),
                    speSkillCon("（属性乘区·攻击力加成）", SkillColorEnum.injuries),
                    "",
                    "提升",
                    ...
                    "",
                    "提升",
                    speSkillCon("30%[同调者专精]", SkillColorEnum.normal, ToastSkillEnum.同调者专精),
    ...
    "昊苍": [
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("300"),
                    "范围内距离自身最近的一名敌方造成",
                    speSkillCon("2700%最终攻击的炎元素伤害"),
                    "并对其他敌人造成",
                    speSkillCon("900%最终攻击的炎元素伤害"),
                    "，随后突进回初始位置",
                    "",
    ...
    "百里屠苏": [
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    "；对范围内的所有敌方地面单位共造成",
                    speSkillCon("750%最终攻击的炎元素伤害"),
                    "+",
                    speSkillCon("1000%体质的炎元素伤害"),
                    "，同时附带破坏",
                    speSkillCon("2段格挡条"),
                    "效果；且「梦中身」会同时造成",
                    speSkillCon("750%最终攻击的炎元素伤害"),
                    ...
                    "",
                    "对范围内的所有敌方单位共造成",
                    speSkillCon("2500%最终攻击的炎元素伤害"),
                    "+",
                    speSkillCon("2500%体质的炎元素伤害"),
                    "，同时附带破坏",
                    speSkillCon("5段格挡条"),
                    "效果，对当前生命值低于",
                    speSkillCon("50%"),
        ...
        },
        {
            ...
            "detail": {
                ...
                "content": [
                    ...
                    speSkillCon("300"),
                    "扇形范围内所有敌方地面单位造成",
                    speSkillCon("1750%最终攻击的炎元素伤害"),
                    "+",
                    speSkillCon("1750%体质的炎元素伤害"),
                    "，同时附带破坏",
                    speSkillCon("4段格挡条"),
                    "效果",
                    "",
