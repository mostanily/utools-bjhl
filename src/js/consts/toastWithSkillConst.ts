...
const toastWithSkill = [
    ...
    ["【冰点协议】",
        [
            "为被赋予的目标抵御伤害，施加伤害抵挡量时，不计入目标的受治疗加成",
            "",
            "同调者身上存在的「冰点协议」最大不超过言御最大生命值的2倍"
        ]
    ],
    ["【极寒测试】",
        [
            "使友方同调者下一次普通攻击时，以普通攻击目标为中心，造成一次基于言御最终攻击力的范围霜元素伤害，该伤害在“潮湿”环境下会直接生成霜元素区域",
            "",
            "极寒测试视为友方造成的伤害，除最终攻击力外的所有属性使用友方自身的加成"
        ]
    ],
    ...
    ["【苦痛涡核】",
        [
            "对敌人施加「苦痛涡核标记」，如果敌人已拥有「苦痛涡核标记」则消耗标记并造成「苦痛涡核引爆」伤害",
            "",
    ...
    ["【爆燃反应】",
        [
            ...
            speSkillCon("雷元素", SkillColorEnum.orange),
            "伤害的",
            speSkillCon("【爆燃】", SkillColorEnum.normal),
            "反应",
            "",
            "目标处于",
            speSkillCon("雷元素", SkillColorEnum.orange),
            ...
            "和",
            speSkillCon("专精值"),
            "的伤害（不会清除炎/雷元素区域，且不会再次触发元素反应），该伤害会正常受到抗性或减伤的增益和减益效果。",
            "",
            "反应免疫类型为",
            speSkillCon("炎", SkillColorEnum.injuries),
            "或",
            speSkillCon("雷", SkillColorEnum.orange),
            "的单位及部分特殊单位可免疫对应元素伤害类型的爆燃反应。"
        ]
    ],
    ["【电解反应】",
        [
    ...
    ["【翦羽】", "可以通过施放技能获取[翦羽]，施放异核技能需要消耗一定数量的[翦羽]"],
    ["【目标减益乘区·目标基础减伤降低】", "目标基础减伤最多被降至-100%（包含忽略减伤部分）"],
    ["【同调者临时元素变更】", "能够触发在战斗中激活的和元素属性相关的效果，但在元素属性改变前就已经触发的效果不会被触发。"],
    ["【属性乘区·属性增伤】", "属性增伤最多为60%，仅生效其中的最大值。每个元素（包含物理）单独计算"],
    ["【属性乘区·自动技能回复速度】", "自动技能回复速度最多为150%"],
    ["【风化反应】", "由风和蚀或风和水反应触发，使目标降低两种反应元素的抗性各5%，效果可叠加至75%。"],
    ["【风化元素伤害】", "属于特殊风元素伤害，可额外再受到蚀元素或水元素抗性降低效果加成，取蚀或水元素抗性降低效果的最大值。"],
    ["【潮湿效果】", "属于减益效果，其他元素伤害命中带有该效果的敌方时会触发水元素相关的反应"],
    ["【元素反应触发增伤】", "元素反应触发的目标受到伤害提高的效果，仅生效其中的最大值"],
    ["【激励】",
        [
            "每层激励效果提升10%伤害，最多同时生效20层",
            "",
            "※标注为“激励技能”的刻印技能在满足特定条件后，能够为小队中的所有同调者提供激励效果",
            "",
            "※在玩法「思维演绎」中，每层激励效果提升5%伤害"
        ]
    ],
];
...
const laohenToastWithSkill = [
    ...
    ["【雷之界域】", "可视为雷元素区域，并触发雷元素相关的元素反应（如传导、爆燃、电解反应）"],
    ["【属性乘区·暴击伤害】", "数据缺失"],
    ["【属性乘区·刻印攻击百分比增加】", "同调者的刻印攻击百分比加成最多为300%"],
    ["【潮湿效果】", "属于减益效果，其他元素伤害命中带有该效果的敌方时会触发水元素相关的反应"],
    ["【同调者攻击】", "获得多个[同调者攻击]提升效果时，仅生效其中的最大值"],
]
