...
const allLaohenSkill: DefaultLaohenSkillObj[] = [
    ...
    },
    {
        ...
        "detail": [
            "同调者的攻击速度提高20%",
            speSkillCon("(属性乘区·额外攻击速度)", SkillColorEnum.injuries),
            "；且同调者施放普通攻击时，自身刻印攻击提高",
            speSkillCon("1.5％（等级1时）"),
            "/",
            speSkillCon("3.0％（等级2时）"),
            "/",
            speSkillCon("4.5％（等级3时）"),
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "，持续30秒，最多可叠加5次。",
            "",
            "上述效果炎元素同调者翻倍",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.泅游], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者每施放4次普通攻击，其中第4次施放普通攻击时会选择1个敌方目标（目标会选择该次普通攻击伤害命中的目标中血量较多及精英首领单位），对目标位置造成半径100范围伤害为自身最终攻击",
            speSkillCon("9（等级1时）"),
            "/",
            speSkillCon("18（等级2时）"),
            "/",
            speSkillCon("27（等级3时）"),
            "的炎元素伤害，该效果每个同调者每5秒最多触发1次"
        ]
    },
    {
        "name": "元素领袖·炎", //技能名称
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.执愿], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "施放战术终端技能时，场上所有同调者回复",
            speSkillCon("10.0（等级1时）"),
            "/",
            speSkillCon("20.0（等级2时）"),
            "/",
            speSkillCon("30.0（等级3时）"),
            "秒异核充能",
        ]
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.问天], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "当有敌方目标处在炎元素区域时，同调者施展主动技能后场上所有同调者获得2层",
            speSkillCon("[激励]"),
            "，通过该效果获得的",
            speSkillCon("[激励]"),
            "不能超过",
    ...
    },
    {
        ...
        "detail": [
            ...
            speSkillCon("20%（等级3时）"),
            speSkillCon("(属性乘区·额外攻击力加成)", SkillColorEnum.injuries),
            "，持续30秒且效果不可叠加（进入隐匿的同调者离场或重伤后效果消失），若职业为<轻卫、铁御、尖锋>时该效果翻倍"
        ],
        "speSkillToast": [
            speLaohenSkillCon(LaohenToastSkillEnum.隐匿),
            speLaohenSkillCon(LaohenToastSkillEnum.属性乘区额外攻击力加成),
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.新醅], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者对敌人造成伤害后，在受到伤害的所有敌人上留下「疏文」（同一个敌人只受到一个「疏文」的影响），同调者施放自动技能时引爆场上「疏文」，对带「疏文」目标造成施放者最终攻击",
            speSkillCon("2000%（等级1时）"),
            "/",
            speSkillCon("3000%（等级2时）"),
            "/",
            speSkillCon("4000%（等级3时）"),
            speSkillCon("(属性乘区·额外攻击力加成)", SkillColorEnum.injuries),
            "的单体物理伤害，若同调者施放自动技能时处于",
            speSkillCon("[隐匿]"),
            "状态则该引爆伤害额外提高12%",
            speSkillCon("(增伤乘区·独立增伤)", SkillColorEnum.injuries),
            "（「疏文」引爆后目标5秒内无法再次被添加）"
    ...
    },
    {
        ...
        "detail": [
            "当场上存在<轻卫或铁御>时，自身刻印攻击提高",
            speSkillCon("5.0%（等级1时）"),
            "/",
            speSkillCon("10.0%（等级2时）"),
            "/",
            speSkillCon("15.0%（等级3时）"),
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "，若存在2名及以上<轻卫或铁御>则刻印攻击提高效果额外增加10%",
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
        ],
        "speSkillToast": [
            speLaohenSkillCon(LaohenToastSkillEnum.隐匿)
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.欢声萦回], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者施放连击技能后额外对场上单体敌方目标（优先选择精英及首领单位）造成以其为中心半径300范围的刻印终端",
            speSkillCon("5000%（等级1时）"),
            "/",
            speSkillCon("10000%（等级2时）"),
            "/",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.萌火直出], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者对友方同调者造成治疗时，提高受治疗目标",
            speSkillCon("7.0％（等级1时）"),
            "/",
            speSkillCon("14.0％（等级2时）"),
            "/",
            speSkillCon("20.0％（等级3时）"),
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "刻印攻击，若为水元素同调者造成治疗则效果额外提高10％",
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "，持续15秒，重复触发刷新持续时间",
        ]
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.沙中金火], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者拥有护盾时，每5秒回复自身1秒异核充能并对自身周围300范围内的敌人造成最终攻击",
            speSkillCon("400％（等级1时）"),
            "/",
            speSkillCon("800％（等级2时）"),
            "/",
            speSkillCon("1200％（等级3时）"),
            "的水元素伤害",
        ]
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.余兴节目], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者拥有护盾时施放主动技能后场上所有同调者获得2层",
            speSkillCon("[激励]"),
            "，通过该效果获得的",
            speSkillCon("[激励]"),
            "不能超过",
    ...
    },
    {
        ...
        "detail": [
            ...
            speSkillCon("24%（等级3时）"),
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "，雷元素同调者效果翻倍，持续60秒，该效果不可叠加，重复触发刷新持续时间",
        ]
    },
    {
        "name": "元素之境", //技能名称
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.失罪夜], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者触发",
        ...
        "speSkillToast": [
            ...
            speLaohenSkillCon(LaohenToastSkillEnum.传导反应),
            speLaohenSkillCon(LaohenToastSkillEnum.电解反应),
            speLaohenSkillCon(LaohenToastSkillEnum.雷之界域),
        ]
    },
    {
        "name": "炎雷同灼", //技能名称
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.燎夜余尘], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "雷元素或炎元素同调者施放异核技能时，场上同调者额外伤害提高",
            speSkillCon("20%（等级1时）"),
            "/",
            speSkillCon("40%（等级2时）"),
            "/",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.局外人], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "使同调者的",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.事无出世间], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者施放异核技能时，自身刻印攻击提高15%",
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "，主动技能回复速度提高",
            speSkillCon("20%（等级1时）"),
            "/",
    ...
    },
    {
        ...
        "isJL": false,
        "rarity": LaohenRarity.ssr, //稀有度，共3种（r，sr，ssr）
        "id": MXLaohenEnum.物能协同,
        "takeEffect": [JobTypeName.轻卫, JobTypeName.尖锋, JobTypeName.铁御], //职业名称
        "useSkill": [
            240,
            240,
            240
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.明日暄风], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者施放异核技能时，场上同调者刻印攻击提高20%",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.无刃之刃], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "雷元素同调者施展主动技能后，自身刻印攻击力提高",
            speSkillCon("15%（等级1时）"),
            "/",
            speSkillCon("30%（等级2时）"),
            "/",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.如长夜振翅], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "施放主动技能后，场上所有同调者获得1层",
            speSkillCon("[激励]"),
            "。蚀元素同调者触发该效果时额外获得2层，通过该效果获得的",
            speSkillCon("[激励]"),
            "不能超过",
            speSkillCon("4（等级1时）"),
            "/",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.烟霞在侧], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "同调者触发元素反应后，提升自身10%",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.旧景三叠], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "施放主动技能后自身刻印攻击提高",
    ...
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.系], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "施放异核技能后，使自身提高",
        ...
        "speSkillToast": [
            speLaohenSkillCon(LaohenToastSkillEnum.同调者攻击),
            speLaohenSkillCon(LaohenToastSkillEnum.属性乘区主动技能回复速度)
        ]
    },
    {
        ...
        "sourseLaohen": {
            "烙痕漫巡技能": [], //枚举LaohenNameEnum.(x)
            "烙痕唤醒技能": [LaohenNameEnum.共弈者], //枚举LaohenNameEnum.(x)
            "队长刻印技能": [] //角色名称
        },
        "detail": [
            "使同调者的",
            ...
            "的可同步上限增加30%",
            "",
            "炎元素同调者施放主动技能后，提升自身16%",
            speSkillCon("(属性乘区·刻印攻击百分比增加)", SkillColorEnum.injuries),
            "刻印攻击力和10.0%",
            speSkillCon("(属性乘区·暴击伤害)", SkillColorEnum.injuries),
            "暴击伤害，持续25秒，重复施加该效果时将会刷新效果的持续时间。效果可叠加",
            speSkillCon("1（等级1时）"),
            "/",
            speSkillCon("2（等级2时）"),
            "/",
...
const allLaohen = [
    AllLaohenHelper.遇见宝石海,
    AllLaohenHelper.月光下的告解,
    AllLaohenHelper.幻想彼境,
    AllLaohenHelper.庆典巡游,
    AllLaohenHelper.残照,
    AllLaohenHelper.幕影重重,
    AllLaohenHelper.天陷,
    AllLaohenHelper.同行,
    AllLaohenHelper.偷偷摩摩,
    AllLaohenHelper.棺中鸟,
    AllLaohenHelper.光阴间隙,
    AllLaohenHelper.角色扮演,
    AllLaohenHelper.逐光者,
    AllLaohenHelper.朗朗乾坤,
    AllLaohenHelper.因果历然,
    AllLaohenHelper.噩梦,
    AllLaohenHelper.双重引力,
    AllLaohenHelper.无罪之徒,
    AllLaohenHelper.向新世界去,
    AllLaohenHelper.底线大作战,
    AllLaohenHelper.失途之日,
    AllLaohenHelper.谎言之下,
    AllLaohenHelper.血露薇绝密,
    AllLaohenHelper.旧友无多,
    AllLaohenHelper.夕阳挽歌,
    AllLaohenHelper.空,
    AllLaohenHelper.晓梦迷花,
    ...
    AllLaohenHelper.藏锋,
    AllLaohenHelper.暗巷漆影,
    AllLaohenHelper.恶土之花,
    AllLaohenHelper.参商形影,
    AllLaohenHelper.千纪启明,
    AllLaohenHelper.如在镜中,
    AllLaohenHelper.问卜天地,
    AllLaohenHelper.烟尘往事,
    AllLaohenHelper.雪轻日暖,
    AllLaohenHelper.最强召唤师,
    AllLaohenHelper.成长,
    AllLaohenHelper.一线之隔,
    AllLaohenHelper.火热手感,
    AllLaohenHelper.最好吃的朋友,
    AllLaohenHelper.醒太平,
    AllLaohenHelper.精准控分,
    AllLaohenHelper.海临人的好奇心,
    AllLaohenHelper.一枕酣甜,
    AllLaohenHelper.玄学,
    AllLaohenHelper.调和清凉,
    AllLaohenHelper.泡影,
    AllLaohenHelper.流星坠处,
    AllLaohenHelper.繁花蜃影,
    AllLaohenHelper.秩序囚笼,
    AllLaohenHelper.拂晓,
    AllLaohenHelper.你好维瑟尔,
    AllLaohenHelper.奢梦,
    AllLaohenHelper.飞驰海岸线,
    AllLaohenHelper.圆锥曲线,
    AllLaohenHelper.意外邂逅,
    AllLaohenHelper.截稿日,
    AllLaohenHelper.增肌训练,
    AllLaohenHelper.化为千鹤,
    AllLaohenHelper.代号百草,
    AllLaohenHelper.记录一夏,
    AllLaohenHelper.速速降温,
    AllLaohenHelper.假日余暇,
    AllLaohenHelper.CATvsDOG,
    AllLaohenHelper.繁星记忆,
    AllLaohenHelper.流光竞夜,
    AllLaohenHelper.不期而遇,
    AllLaohenHelper.家,
    AllLaohenHelper.交换惊喜,
    AllLaohenHelper.团圆,
    AllLaohenHelper.雨中愿,
    AllLaohenHelper.秘密音律,
    AllLaohenHelper.白夜,
    AllLaohenHelper.打成一片,
    AllLaohenHelper.世事难料,
    AllLaohenHelper.街市清晨,
    AllLaohenHelper.樱华如梦,
    AllLaohenHelper.于人海中,
    AllLaohenHelper.书卷晨曦,
    AllLaohenHelper.科技光辉,
    AllLaohenHelper.早日康复,
    AllLaohenHelper.旧城夜幕,
    AllLaohenHelper.万家灯火,
    AllLaohenHelper.混乱烟尘,
    AllLaohenHelper.旖旎夜色,
    AllLaohenHelper.城市嚣音,
    AllLaohenHelper.千本之门,
    AllLaohenHelper.通道,
    AllLaohenHelper.落日残迹,
    AllLaohenHelper.甜蜜心绪,
    AllLaohenHelper.大隐于市,
    AllLaohenHelper.生死在握,
    AllLaohenHelper.旧巷,
    AllLaohenHelper.归档,
    AllLaohenHelper.向阳,
    AllLaohenHelper.魇境边界,
    AllLaohenHelper.曙色的地平线,
    AllLaohenHelper.怯者的墓志铭,
    AllLaohenHelper.未晞,
    AllLaohenHelper.千灯无间,
    AllLaohenHelper.浊雨,
    AllLaohenHelper.野风,
    AllLaohenHelper.度晴波,
    AllLaohenHelper.默,
    AllLaohenHelper.暗涌轮廓,
    AllLaohenHelper.Feat,
    AllLaohenHelper.神迹,
    AllLaohenHelper.TARGETERROR,
    AllLaohenHelper.须臾浮生,
    AllLaohenHelper.泅游,
    AllLaohenHelper.执愿,
    AllLaohenHelper.问天,
    AllLaohenHelper.新醅,
    AllLaohenHelper.欢声萦回,
    AllLaohenHelper.芳年未及,
    AllLaohenHelper.形与神,
    AllLaohenHelper.萌火直出,
    AllLaohenHelper.沙中金火,
    AllLaohenHelper.余兴节目,
    AllLaohenHelper.失罪夜,
    AllLaohenHelper.燎夜余尘,
    AllLaohenHelper.堕入星尘,
    AllLaohenHelper.荣与罪,
    AllLaohenHelper.局外人,
